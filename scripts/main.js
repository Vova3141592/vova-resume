...
// Скрываем курсор, когда мышь уходит за пределы body
const hideCursor = (event) => {
    // Если по координате высоты курсор должен находиться на сайте, не скрываем его
    if (event.clientY > 0) {
        return; // Не скрываем курсор, если по высоте он находится на сайте
    }
